...
use crate::machine::{BootInfo, HexagonBootInfo, Machine};
use crate::vm::vcpu::{CpuState, HexagonRegisters};

const HEXAGON_UART_BASE: u64 = 0xf000_0000;

pub struct HexagonBaremetalMachine;

impl HexagonBaremetalMachine {
    pub fn new() -> Self {
        HexagonBaremetalMachine
    }
...
impl Machine for HexagonBaremetalMachine {
...
pub use HexagonBaremetalMachine as HexagonArch;
