//! ARM guest-machine support.
//!
//! This module provides machine definitions for the ARM family:
...
use crate::machine::{BootInfo, Machine};
...
pub struct Aarch64VirtMachine;

impl Aarch64VirtMachine {
    pub fn new() -> Self {
        Aarch64VirtMachine
    }
    ...
    fn build_dtb(
        ...
        use crate::machine::fdt::FdtBuilder;
...
impl Machine for Aarch64VirtMachine {
    ...
    fn initial_cpu_state(&self, _mem: &GuestMemoryMmap, boot: &BootInfo) -> Result<CpuState> {
        use crate::vm::vcpu::{Aarch64Registers, Aarch64SystemRegisters};
...
impl Machine for Armv7aVirtMachine {
    fn name(&self) -> &'static str {
        "armv7a"
    }
    ...
    fn load_kernel(&self, mem: &GuestMemoryMmap, config: &VmConfig) -> Result<BootInfo> {
        ...
        if std::env::var("RAX_MACHINE").as_deref() == Ok("s5l8900") {
            return crate::machine::s5l8900::boot::load_firmware(mem, config);
        }
    ...
    fn initial_cpu_state(&self, mem: &GuestMemoryMmap, boot: &BootInfo) -> Result<CpuState> {
        use crate::vm::vcpu::{Aarch32Registers, Aarch32SystemRegisters};
...
pub struct Armv8a32VirtMachine;

impl Armv8a32VirtMachine {
    pub fn new() -> Self {
        Armv8a32VirtMachine
    }
}

impl Machine for Armv8a32VirtMachine {
    fn name(&self) -> &'static str {
        "armv8a32"
    }
    ...
    fn load_kernel(&self, mem: &GuestMemoryMmap, config: &VmConfig) -> Result<BootInfo> {
        ...
        Armv7aVirtMachine::new().load_kernel(mem, config)
    }
    ...
    fn initial_cpu_state(&self, mem: &GuestMemoryMmap, boot: &BootInfo) -> Result<CpuState> {
        // Same as ARMv7-A for now
        Armv7aVirtMachine::new().initial_cpu_state(mem, boot)
    }
}
...
impl Machine for CortexMMachine {
    fn name(&self) -> &'static str {
        "cortex-m"
    }
...
impl Machine for CortexRMachine {
    fn name(&self) -> &'static str {
        "cortex-r"
    }
...
// Compatibility names retained for the previous architecture terminology.
pub use Aarch64VirtMachine as Aarch64Arch;
pub use Armv7aVirtMachine as Armv7aArch;
pub use Armv8a32VirtMachine as Armv8a32Arch;
pub use CortexMMachine as CortexMArch;
pub use CortexRMachine as CortexRArch;
