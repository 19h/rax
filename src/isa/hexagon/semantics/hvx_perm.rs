...
//! verified against the qemu-hexagon vector oracle
//! (`tests/suites/differential/hexagon/hvx.rs`).
//! See semantics/hvx.rs for the established 128-byte lane pattern and the SemCtx
