...
//! oracle (`tests/suites/differential/hexagon/hvx.rs`). Semantics taken
//! verbatim from the V60/V69
...
//!
//! Lane conventions match semantics/hvx.rs: a vector is 128 bytes, little-endian within
