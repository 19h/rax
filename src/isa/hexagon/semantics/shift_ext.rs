...
//! `qemu-hexagon` reference oracle
//! (`tests/suites/differential/hexagon/scalar.rs`). See `semantics/alu.rs`
//! and `semantics/shift.rs` for the established pattern.
...
mod tests {
    use super::*;
    use crate::isa::hexagon::opcode::decode_word;
