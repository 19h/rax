...
//! against the qemu-hexagon vector oracle
//! (`tests/suites/differential/hexagon/hvx.rs`). See
//! semantics/hvx_mpy.rs for the 128-byte lane pattern and the SemCtx vector API.
//!
