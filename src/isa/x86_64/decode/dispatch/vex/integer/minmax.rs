...
impl X86_64Vcpu {
    pub(in crate::isa::x86_64) fn execute_vex_pminmax_sb(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_pminmax_sd(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_pminmax_uw(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_pminmax_ud(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
