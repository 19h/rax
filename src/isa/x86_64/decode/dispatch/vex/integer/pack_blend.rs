...
impl X86_64Vcpu {
    pub(in crate::isa::x86_64) fn execute_vex_pblendvb(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_packusdw(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_packsswb(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_packssdw(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_packuswb(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_blendw(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_blendd(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
