...
impl X86_64Vcpu {
    pub(in crate::isa::x86_64) fn execute_vex_arith(
        &mut self,
        ctx: &mut InsnContext,
        vex_pp: u8,
        vex_l: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_roundp(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_rounds(
        &mut self,
        ctx: &mut InsnContext,
        vvvv: u8,
        opcode: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_dp(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
