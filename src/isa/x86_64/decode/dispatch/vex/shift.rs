...
impl X86_64Vcpu {
    pub(in crate::isa::x86_64) fn execute_vex_packed_shift_imm(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_packed_shift_xmm(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_variable_shift(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
