...
impl X86_64Vcpu {
    pub(in crate::isa::x86_64) fn execute_vex_broadcast(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        opcode: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_broadcast_128(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
    ...
    pub(in crate::isa::x86_64) fn execute_vex_broadcast_fp(
        &mut self,
        ctx: &mut InsnContext,
        vex_l: u8,
        vvvv: u8,
