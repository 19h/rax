...
impl X86_64Vcpu {
    ...
    pub(in crate::isa::x86_64) fn execute_sse_add(
        &mut self,
        ctx: &mut InsnContext,
    ...
    pub(in crate::isa::x86_64) fn execute_sse_sub(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_mul(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_div(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_sqrt(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_rsqrt(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    /// SSE reciprocal (0x53)
    pub(in crate::isa::x86_64) fn execute_sse_rcp(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_min(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_max(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_unpcklps(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_sse_unpckhps(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_punpck(
        &mut self,
        ctx: &mut InsnContext,
        opcode: u8,
    ) -> Result<Option<VcpuExit>> {
    ...
    pub(in crate::isa::x86_64) fn execute_pinsrw(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_pextrw(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
    ...
    pub(in crate::isa::x86_64) fn execute_pshufd(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_cmpps(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn cmp_predicate_f32(&self, a: f32, b: f32, pred: u8) -> bool {
        match pred & 0x1F {
            0x00 => a == b,                                // EQ_OQ
            0x01 => a < b,                                 // LT_OS
            0x02 => a <= b,                                // LE_OS
    ...
    pub(in crate::isa::x86_64) fn cmp_predicate_f64(&self, a: f64, b: f64, pred: u8) -> bool {
        match pred & 0x1F {
            0x00 => a == b,
            0x01 => a < b,
            0x02 => a <= b,
    ...
    pub(in crate::isa::x86_64) fn execute_movnt_store(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
    ...
    pub(in crate::isa::x86_64) fn execute_movnt_scalar_store(
        &mut self,
        ctx: &mut InsnContext,
        size: u8,
    ) -> Result<Option<VcpuExit>> {
    ...
    pub(in crate::isa::x86_64) fn execute_comiss(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_movmsk(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, _addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_shufps(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_hadd(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_hsub(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn execute_shift_imm_group12(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
    ...
    pub(in crate::isa::x86_64) fn execute_shift_imm_group13(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let modrm = ctx.consume_u8()?;
    ...
    pub(in crate::isa::x86_64) fn execute_shift_imm_group14(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let modrm = ctx.consume_u8()?;
    ...
    pub(in crate::isa::x86_64) fn execute_addsubps(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
        let (reg, rm, is_memory, addr, _) = self.decode_modrm(ctx)?;
    ...
    pub(in crate::isa::x86_64) fn restore_xsave_compacted_area(
        &mut self,
        addr: u64,
    ) -> Result<bool> {
        let rfbm = self.xsave_requested_feature_bitmap();
    ...
    pub(in crate::isa::x86_64) fn execute_group9(
        &mut self,
        ctx: &mut InsnContext,
    ) -> Result<Option<VcpuExit>> {
