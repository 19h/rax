...
//!
//! ```ignore
//! use rax::isa::arm::decoder::{Decoder, DecodedInsn};
//!
...
// Compatibility aliases for the pre-grouping ARM module paths.
pub use aarch32::{cp15, cpu as execution, instructions, mmu_v6, vfp};
pub use common::{cpu as cpu_trait, features, isa, memory, state, sysreg};
