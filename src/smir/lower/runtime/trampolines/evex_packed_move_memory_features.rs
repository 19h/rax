//! Feature accumulation for writemasked EVEX packed-move memory replays.
...
pub(super) fn accumulate_evex_packed_move_memory_requirements(
    block: &SmirBlock,
    index: usize,
    ...
    let sequence = super::x86_jit_evex_packed_move_memory_sequence(
        block,
        index,
        true,
