...
#[test]
fn replay_emits_exact_flag_neutral_state_commits_for_all_1728_o0_o2_cases() {
...
fn replay_fails_closed_without_exact_stack_destination_provenance() {
    ...
    for nonmatching in [missing, ordinary_metadata, vvvv_metadata, memory_metadata] {
...
#[test]
fn interpreter_matches_intel_o0_o2_all_864_encodings_and_full_state() {
...
#[cfg(target_arch = "x86_64")]
#[test]
fn replay_matches_intel_o0_o2_all_864_encodings_and_full_state() {
    ...
    run_isolated_native_differential(
        "smir::lower::runtime::jit_gate_tests::vex_mov_mask_stack_destination_replay::\
         replay_matches_intel_o0_o2_all_864_encodings_and_full_state",
    );
}
