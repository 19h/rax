...
extern "C" fn scalar_load_helper(
    ...
    LoadResult {
        value: match context.elem_bytes {
            ...
            _ => unreachable!("VALIGN scalar helper width"),
        },
        ok: 1,
    }
}
...
fn selected_cases() -> [AlignMemoryCase; 8] {
    [
        AlignMemoryCase {
...
#[test]
fn native_valign_memory_matches_interpreter_and_e4nf_faults_before_commit() {
    use super::super::vex_fma3_memory_source::{VectorMemoryContext, vector_load_helper};

    if !std::is_x86_feature_detected!("avx512f") || !std::is_x86_feature_detected!("avx512bw") {
        eprintln!("skipping native VALIGN memory differential: host lacks AVX-512F/BW");
        return;
    }
