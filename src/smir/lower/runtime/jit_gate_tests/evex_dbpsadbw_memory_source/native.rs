//! Native x86-64 differential, helper-call, scratch, and precise-fault coverage.
...
fn selected_cases() -> [DbpsadbwMemoryCase; 8] {
    [
        DbpsadbwMemoryCase {
            width: VecWidth::V128,
            destination: 1,
...
#[test]
fn native_vdbpsadbw_matches_interpreter_restores_scratch_and_preserves_e4nf_faults() {
    use super::super::vex_fma3_memory_source::{VectorMemoryContext, vector_load_helper};

    if !std::is_x86_feature_detected!("avx512f") || !std::is_x86_feature_detected!("avx512bw") {
        eprintln!("skipping native VDBPSADBW differential: host lacks AVX-512F/BW");
        return;
    }
