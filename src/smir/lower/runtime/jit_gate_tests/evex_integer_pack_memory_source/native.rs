...
fn selected_cases() -> [IntegerPackMemoryCase; 8] {
    [
...
#[test]
fn native_integer_pack_matches_interpreter_and_type_e4nf_faults_before_commit() {
    use super::super::vex_fma3_memory_source::{VectorMemoryContext, vector_load_helper};

    if !std::is_x86_feature_detected!("avx512f") || !std::is_x86_feature_detected!("avx512bw") {
        eprintln!("skipping native EVEX integer-pack differential: host lacks AVX-512F/BW");
        return;
    }
