...
extern "C" fn lane_load_helper(
    ...
    LoadResult {
        value: match context.lane_bytes {
            ...
            _ => unreachable!("packed rotate scalar helper width"),
        },
        ok: 1,
    }
}
...
fn selected_cases() -> [RotateMemoryCase; 8] {
    [
        RotateMemoryCase {
...
#[test]
fn native_memory_rotates_match_interpreter_helpers_faults_and_mask_suppression() {
    use super::super::vex_fma3_memory_source::{VectorMemoryContext, vector_load_helper};

    if !std::is_x86_feature_detected!("avx512f") || !std::is_x86_feature_detected!("avx512bw") {
        eprintln!("skipping native packed-rotate memory differential: host lacks AVX-512F/BW");
        return;
    }
