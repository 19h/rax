...
impl X86InstructionBytes {
    ...
    /// LLIG and require neither AVX-512VL nor AVX-512DQ. `VMOVSS` and `VMOVSD`
    /// require AVX-512F; `VMOVSH` requires AVX-512-FP16. Register forms consume
    /// EVEX.vvvv/V' as the upper-XMM merge source. EVEX.b, malformed zeroing
    /// with k0, memory forms, and every non-family opcode field fail closed.
