...
pub(crate) use classifiers::{
    ...
    X86EvexHalfMoveMemoryEncoding, X86EvexIntegerArithmeticMemoryEncoding,
    X86EvexIntegerArithmeticMemoryReplay, X86EvexIntegerInterleaveMemoryEncoding,
    X86EvexIntegerMinMaxMemoryEncoding, X86EvexIntegerNarrowMemoryEncoding,
