...
pub(crate) use classifiers::{
    ...
    X86EvexFixupImmMemoryEncoding, X86EvexFixupImmMemoryReplay, X86EvexGfniAffineMemoryEncoding,
    X86EvexGfniAffineMemoryReplay, X86EvexIntegerArithmeticMemoryEncoding,
    X86EvexIntegerArithmeticMemoryReplay, X86EvexIntegerMinMaxMemoryEncoding,
