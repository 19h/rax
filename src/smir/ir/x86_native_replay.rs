...
pub(crate) use classifiers::{
    ...
    X86EvexFixupImmMemoryReplay, X86EvexFpInterleaveMemoryEncoding,
    ...
    X86EvexPackedIntegerMaskOperation, X86EvexPackedRotateMemoryEncoding,
    X86EvexPackedRotateMemoryReplay, X86EvexPackedVariableShiftMemoryEncoding,
    X86EvexPackedVariableShiftMemoryReplay, X86EvexRangeMemoryEncoding, X86EvexRangeMemoryReplay,
    X86EvexScalarFma3MemoryEncoding, X86EvexScalarFpArithmeticMemoryEncoding,
    X86EvexScalarFpConvertMemoryEncoding, X86EvexScalarFpUnaryMemoryEncoding,
    X86EvexScalarFpUnaryMemoryKind, X86EvexScaleFMemoryEncoding, X86EvexScaleFMemoryReplay,
