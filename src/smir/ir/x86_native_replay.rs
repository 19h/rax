...
pub(crate) use classifiers::{
    ...
    X86EvexScalarIntToFpMemoryEncoding, X86EvexScalarMoveMemoryEncoding,
    X86EvexScalarMoveMemoryKind, X86EvexScaleFMemoryEncoding, X86EvexScaleFMemoryReplay,
    ...
    X86EvexVp2IntersectMemoryEncoding, X86EvexVp2IntersectMemoryReplay,
