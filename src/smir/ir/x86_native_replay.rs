...
pub(crate) use classifiers::{
    ...
    X86EvexFourFmaMemoryEncoding, X86EvexFpInterleaveMemoryEncoding,
    ...
    X86EvexIntegerUnaryMemoryKind, X86EvexIntegerUnaryMemoryReplay, X86EvexLogicMemoryEncoding,
