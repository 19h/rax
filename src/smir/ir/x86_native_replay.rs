...
pub(crate) use classifiers::{
    ...
    X86EvexDbpsadbwMemoryEncoding, X86EvexDuplicateMoveMemoryEncoding, X86EvexExpandMemoryEncoding,
    X86EvexExpandMemoryReplay, X86EvexFixupImmMemoryEncoding, X86EvexFixupImmMemoryReplay,
    X86EvexFourFmaMemoryEncoding, X86EvexFpClassMemoryEncoding, X86EvexFpClassMemoryReplay,
    X86EvexFpInterleaveMemoryEncoding, X86EvexFpInterleaveMemoryReplay,
    X86EvexFpShuffleMemoryEncoding, X86EvexFpShuffleMemoryReplay, X86EvexFullPermuteControl,
    X86EvexFullPermuteMemoryEncoding, X86EvexFullPermuteMemoryReplay,
    ...
    X86EvexIntegerPackMemoryEncoding, X86EvexIntegerUnaryMemoryEncoding,
    X86EvexIntegerUnaryMemoryKind, X86EvexIntegerUnaryMemoryReplay, X86EvexLaneShuffleKind,
    X86EvexLaneShuffleMemoryEncoding, X86EvexLaneShuffleMemoryReplay, X86EvexLogicMemoryEncoding,
    X86EvexLogicMemoryKind, X86EvexMaskBlendMemoryEncoding, X86EvexMaskBlendMemoryReplay,
    X86EvexMaskedLogicMemoryEncoding, X86EvexMultiShiftMemoryEncoding,
    X86EvexMultiShiftMemoryReplay, X86EvexPackedAbsMemoryEncoding,
    ...
    X86EvexScalarFma3MemoryEncoding, X86EvexScalarFpArithmeticMemoryEncoding,
    ...
    X86EvexVpshufbitqmbMemoryReplay, X86VexChunkExtractMemoryEncoding,
