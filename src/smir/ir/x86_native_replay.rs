...
pub(crate) use classifiers::{
    ...
    X86EvexDbpsadbwMemoryEncoding, X86EvexDuplicateMoveMemoryEncoding,
    X86EvexFixupImmMemoryEncoding, X86EvexFixupImmMemoryReplay, X86EvexFourFmaMemoryEncoding,
    X86EvexFpClassMemoryEncoding, X86EvexFpClassMemoryReplay, X86EvexFpInterleaveMemoryEncoding,
