...
pub(crate) use classifiers::{
    ...
    X86VexImmediatePermuteMemoryEncoding, X86VexMovntdqaMemoryEncoding, X86VexNeConvertKind,
    X86VexNeConvertMemoryEncoding, X86VexPackedConvertMemoryEncoding,
    X86VexPackedConvertMemoryKind, X86VexPhminposuwMemoryEncoding, X86VexPtestMemoryEncoding,
