...
pub(crate) use classifiers::{
    ...
    X86EvexFpShuffleMemoryEncoding, X86EvexFpShuffleMemoryReplay, X86EvexGfniAffineMemoryEncoding,
    X86EvexGfniAffineMemoryReplay, X86EvexIntegerArithmeticMemoryEncoding,
    X86EvexIntegerArithmeticMemoryReplay, X86EvexIntegerInterleaveMemoryEncoding,
    X86EvexIntegerMinMaxMemoryEncoding, X86EvexIntegerPackMemoryEncoding,
