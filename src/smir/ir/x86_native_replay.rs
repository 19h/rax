...
pub(crate) use classifiers::{
    ...
    X86EvexChunkShuffleMemoryReplay, X86EvexFixupImmMemoryEncoding, X86EvexFixupImmMemoryReplay,
    ...
    X86EvexScalarFma3MemoryEncoding, X86EvexScaleFMemoryEncoding, X86EvexScaleFMemoryReplay,
