//! Exact classifier tests for EVEX scalar floating-point-to-integer replay.
...
#[test]
fn classifier_accepts_exactly_3_840_sampled_legal_register_encodings() {
