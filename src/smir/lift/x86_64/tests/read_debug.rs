...
#[test]
fn mov_from_debug_register_accepts_ignored_prefixes_and_rejects_invalid_extensions() {
    for prefix in [
    ...
    for bytes in [
        &[0xF0, 0x0F, 0x21, 0xC0][..], // LOCK
        &[0x44, 0x0F, 0x21, 0xC0],     // REX.R
        &[0xD5, 0x80, 0x21, 0xC0],     // REX2 map-0F
    ] {
        assert!(
