...
// default after all assigned RAX-profile encodings are dispatched. 0F 37 is
// GETSEC behind disabled SMX; the other facility-assigned VMX cells 0F 78/79
// and their mandatory-prefix SSE4A forms have their own exact dispatcher.
const PROFILE_TERMINAL_0F_OPCODES: &[u8] = &[
    0x1D, 0x24, 0x25, 0x26, 0x27, 0x36, 0x37, 0x39, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x7A, 0x7B, 0xA6,
    0xA7,
];
...
fn legacy_0f_terminal_preserves_prefix_frontiers() {
    for (bytes, expected_len) in [
        (&[0x0F, 0x1D, 0xC0][..], 2),
        (&[0x64, 0x67, 0x48, 0x0F, 0x1D, 0xC0][..], 5),
