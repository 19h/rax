...
fn test_pcmpeqb_partial_match() {
    ...
    write_mm_via_mem(&mem, 0x2000, 0x01FF03FF05FF07FF);
    write_mm_via_mem(&mem, 0x2008, 0x0102030405060708);
...
fn test_pcmpeqb_alternating() {
    ...
    write_mm_via_mem(&mem, 0x2008, 0xAA00AA00AA00AA00);
...
fn test_pcmpeqb_mm5_mm6() {
    ...
    write_mm_via_mem(&mem, 0x2000, 0x0011223344556677);
    write_mm_via_mem(&mem, 0x2008, 0x0011223344556600);
...
fn test_pcmpeqw_all_different() {
    ...
    write_mm_via_mem(&mem, 0x2008, 0x0005000600070008);
...
fn test_pcmpeqw_partial_match() {
    ...
    write_mm_via_mem(&mem, 0x2000, 0x1234FFFF90AB0000);
    write_mm_via_mem(&mem, 0x2008, 0x1234567890AB0000);
...
fn test_pcmpeqw_mm7_mm0() {
    ...
    write_mm_via_mem(&mem, 0x2008, 0xAAAA0000AAAA0000);
...
fn test_pcmpeqd_all_different() {
    ...
    write_mm_via_mem(&mem, 0x2008, 0x0000000300000004);
...
fn test_pcmpeqd_partial_match() {
    ...
    write_mm_via_mem(&mem, 0x2000, 0x1234567800000000);
    write_mm_via_mem(&mem, 0x2008, 0x1234567890ABCDEF);
...
fn test_pcmpeqd_mm4_mm3() {
    ...
    write_mm_via_mem(&mem, 0x2000, 0xAAAAAAAA00000000);
    write_mm_via_mem(&mem, 0x2008, 0xAAAAAAAA12345678);
...
fn test_pcmpeqd_high_low_swapped() {
    ...
    write_mm_via_mem(&mem, 0x2000, 0x1234567890ABCDEF);
    write_mm_via_mem(&mem, 0x2008, 0x90ABCDEF12345678);
...
fn test_all_compare_sizes() {
    // Test all three sizes with same data
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00,
        0x0f, 0x6f, 0x0c, 0x25, 0x08, 0x20, 0x00, 0x00,
        0x0f, 0x6f, 0x14, 0x25, 0x00, 0x20, 0x00, 0x00,
    ...
    let byte_cmp = read_mem_at_u64(&mem, 0x2010);
    let word_cmp = read_mem_at_u64(&mem, 0x2018);
    let dword_cmp = read_mem_at_u64(&mem, 0x2020);
...
fn test_compare_as_mask() {
    // Use compare result as mask for PAND
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00,
        0x0f, 0x6f, 0x0c, 0x25, 0x08, 0x20, 0x00, 0x00,
    ...
    // Mask is FF00FF00FF00FF00, so only matching bytes pass through
