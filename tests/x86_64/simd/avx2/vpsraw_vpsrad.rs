...
fn test_vpsraw_negative_values() {
    // Test arithmetic shift with negative values (sign extension)
    let code = [
        0xc5, 0xf5, 0x71, 0xe1, 0x01, // VPSRAW YMM0, YMM1, 1
...
fn test_vpsraw_positive_values() {
    // Test arithmetic shift with positive values
    let code = [
        0xc5, 0xf5, 0x71, 0xe1, 0x01, // VPSRAW YMM0, YMM1, 1
        0xf4, // HLT
    ];
...
fn test_vpsraw_sign_extension_negative() {
    // Test that negative values get sign extended (filled with 1s)
    let code = [
