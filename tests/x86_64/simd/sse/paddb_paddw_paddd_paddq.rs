...
fn test_paddq_xmm3_xmm4() {
    ...
    let (mut vcpu, mem) = setup_vm(&full_code, None);
    mem.write_slice(&[0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
                      0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22],
                     GuestAddress(ALIGNED_ADDR)).unwrap();
    mem.write_slice(&[0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE,
...
fn test_paddq_from_memory() {
    ...
    mem.write_slice(&[0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                     ...
                     GuestAddress(ALIGNED_ADDR)).unwrap();
    mem.write_slice(&[0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F,
