...
fn test_crc32_r32_r8_accumulate() {
    // Test accumulation - multiple CRC32 operations
    let code = [
...
fn test_crc32_mixed_sizes() {
    // Accumulate CRC using different operand sizes
    let code = [
        0xb8, 0x00, 0x00, 0x00, 0x00, // MOV EAX, 0
        0xb1, 0x41, // MOV CL, 'A'
...
fn test_crc32_mixed_64bit_sizes() {
    // Use 64-bit destination with various source sizes
    let code = [
        0x48, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // MOV RAX, 0
        0xb1, 0x58, // MOV CL, 'X'
...
fn test_crc32_r32_r8l() {
    // Test with low byte of extended register (SPL, BPL, SIL, DIL)
    let code = [
        0xb8, 0x00, 0x00, 0x00, 0x00, // MOV EAX, 0
...
fn test_crc32_string_abc() {
    // Compute CRC32 of "abc" byte by byte
    let code = [
        0xb8, 0x00, 0x00, 0x00, 0x00, // MOV EAX, 0
        0xb1, 0x61, // MOV CL, 'a'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, // CRC32 EAX, CL
...
fn test_crc32_multiple_sequences() {
    // Compute multiple independent CRCs
    let code = [
        // First CRC
        0xb8, 0x00, 0x00, 0x00, 0x00, // MOV EAX, 0
        0xb1, 0x41, // MOV CL, 'A'
