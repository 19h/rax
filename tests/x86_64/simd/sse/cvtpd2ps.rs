...
fn test_cvtpd2ps_mem_to_xmm0() {
    ...
    // Write two float64 values: 1.0 and 2.0
    let f1: f64 = 1.0;
    let f2: f64 = 2.0;
...
fn test_cvtpd2ps_positive_zero() {
    // Test conversion of +0.0 to +0.0f
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_mixed_zeros() {
    // Test conversion of +0.0 and -0.0
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_denormal_positive() {
    // Test conversion of positive denormal (may underflow to 0 in f32)
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
    ...
    // Smallest positive f64 denormal
...
fn test_cvtpd2ps_precision_loss() {
    // Test values that lose precision when converting to f32
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_rounding_nearest() {
    // Test rounding behavior (default is round to nearest even)
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_overflow_to_positive_inf() {
    // Test value that overflows f32 range
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_overflow_to_negative_inf() {
    // Test negative value that overflows f32 range
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_near_max_f32() {
    // Test value near but within f32::MAX
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_large_values() {
    // Test conversion of large normal values (within f32 range)
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_multiple_conversions() {
    // Multiple CVTPD2PS operations in sequence
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_max_float64() {
    // Test conversion of maximum float64 value (should overflow to inf)
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_min_positive_float64() {
    // Test conversion of minimum positive normalized float64
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
...
fn test_cvtpd2ps_upper_bits_zeroed() {
    // Verify upper 64 bits of result are zeroed
    let code = [
        0x48, 0xb8, // MOV RAX, imm64
    ];
    let mut full_code = code.to_vec();
