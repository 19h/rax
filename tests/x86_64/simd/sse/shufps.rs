...
fn test_shufps_xmm0_xmm1_imm_0x00() {
    ...
    // Result: XMM0[0], XMM0[0], XMM1[0], XMM1[0]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0xff() {
    ...
    // Result: XMM0[3], XMM0[3], XMM1[3], XMM1[3]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0xe4() {
    ...
    // Result: XMM0[0], XMM0[1], XMM1[2], XMM1[3]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0x1b() {
    ...
    // Result: XMM0[3], XMM0[2], XMM1[1], XMM1[0]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0x44() {
    ...
    // Result: XMM0[0], XMM0[1], XMM1[0], XMM1[1]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0xee() {
    ...
    // Result: XMM0[2], XMM0[3], XMM1[2], XMM1[3]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0x88() {
    ...
    // Result: XMM0[0], XMM0[2], XMM1[0], XMM1[2]
    let code = [
...
fn test_shufps_xmm0_xmm1_imm_0xdd() {
    ...
    // Result: XMM0[1], XMM0[3], XMM1[1], XMM1[3]
    let code = [
...
fn test_shufps_sequential_operations() {
    // Multiple SHUFPS operations in sequence
    let code = [
        0x0f, 0xc6, 0xc1, 0xe4, // SHUFPS XMM0, XMM1, 0xE4
