...
fn test_pshufd_xmm0_xmm1_imm_0x00() {
    ...
    // Result: [0, 0, 0, 0] - broadcast dword 0
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0x55() {
    ...
    // Result: [1, 1, 1, 1] - broadcast dword 1
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0xaa() {
    ...
    // Result: [2, 2, 2, 2] - broadcast dword 2
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0xff() {
    ...
    // Result: [3, 3, 3, 3] - broadcast dword 3
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0xe4() {
    ...
    // Result: [0, 1, 2, 3] - identity (no change)
    let code = [
...
#[test]
fn test_pshufd_xmm3_xmm4_imm_0xe4() {
    // PSHUFD XMM3, XMM4, 0xE4
    let code = [
        0x66, 0x0f, 0x70, 0xdc, 0xe4, // PSHUFD XMM3, XMM4, 0xE4
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_pshufd_xmm0_xmm1_imm_0x4e() {
    ...
    // Result: [2, 3, 0, 1] - swap low/high pairs
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0xb1() {
    ...
    // Result: [1, 0, 3, 2] - swap within pairs
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0x44() {
    ...
    // Result: [0, 1, 0, 1] - duplicate low pair
    let code = [
...
fn test_pshufd_xmm0_xmm1_imm_0xee() {
    ...
    // Result: [2, 3, 2, 3] - duplicate high pair
    let code = [
...
fn test_pshufd_sequential_operations() {
    // Multiple PSHUFD operations in sequence
    let code = [
        0x66, 0x0f, 0x70, 0xc1, 0xe4, // PSHUFD XMM0, XMM1, 0xE4
