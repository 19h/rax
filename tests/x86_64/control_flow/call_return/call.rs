...
fn test_call_near_relative_basic() {
    let code = [
        0xe8, 0x07, 0x00, 0x00, 0x00, // CALL +7 (to function)
...
fn test_call_ret_round_trip() {
    ...
    assert_eq!(vm.rip, 0x1000 + 20); // Should halt at return point
}
...
fn test_call_forward() {
    let code = [
        0x48, 0xc7, 0xc4, 0x00, 0x20, 0x00, 0x00, // MOV RSP, 0x2000
        0xe8, 0x0b, 0x00, 0x00, 0x00, // CALL +11 (forward to function)
        // return point:
        0x48, 0xff, 0xc0, // INC RAX
        0xf4, // HLT
        // function:
...
fn test_call_backward() {
    let code = [
        0xeb, 0x09, // JMP +9 (skip function)
        // function (offset 2):
        0x48, 0xc7, 0xc0, 0x42, 0x00, 0x00, 0x00, // MOV RAX, 0x42
        0xc3, // RET
        // main (offset 11):
        0x48, 0xc7, 0xc4, 0x00, 0x20, 0x00, 0x00, // MOV RSP, 0x2000
        0xe8, 0xef, 0xff, 0xff, 0xff, // CALL -17 (backward to function)
        // return point:
        0xf4, // HLT
    ];
    let vm = setup_vm(&code);
...
fn test_call_recursive_countdown() {
    let code = [
        ...
        0xe8, 0x04, 0x00, 0x00, 0x00, // CALL countdown
        // main_return:
        0xf4, // HLT
        // countdown function (offset 19):
        0x48, 0x85, 0xc0, // TEST RAX, RAX
        0x74, 0x08, // JZ +8 (return if zero)
        0x48, 0xff, 0xc8, // DEC RAX
        0xe8, 0xf5, 0xff, 0xff, 0xff, // CALL countdown (recursive)
        0xc3, // RET
        // base case:
        0xc3, // RET
    ];
...
fn test_call_recursive_factorial() {
    ...
    let code = [
        ...
        0x7e, 0x0f, // JLE +15 (base case: return 1)
        // recursive case:
        0x53, // PUSH RBX
        0x48, 0x89, 0xc3, // MOV RBX, RAX (save n)
        0x48, 0xff, 0xc8, // DEC RAX (n-1)
        0xe8, 0xf1, 0xff, 0xff, 0xff, // CALL factorial
...
fn test_call_multiple_sequential() {
    let code = [
        ...
        0xe8, 0x0e, 0x00, 0x00, 0x00, // CALL func1
        0xe8, 0x0e, 0x00, 0x00, 0x00, // CALL func2
        0xe8, 0x0e, 0x00, 0x00, 0x00, // CALL func3
        0xf4, // HLT
        // func1:
...
fn test_call_return_address_is_next_instruction() {
    let code = [
        0x48, 0xc7, 0xc4, 0x00, 0x20, 0x00, 0x00, // MOV RSP, 0x2000
        0xe8, 0x0b, 0x00, 0x00, 0x00, // CALL function (at offset 7)
        // return point (offset 12):
