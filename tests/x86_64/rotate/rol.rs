...
fn test_rol_bl() {
    ...
    assert_eq!(regs.rbx & 0xFF, 0x8B, "BL: 0xC5 ROL 1 = 0x8B");
...
fn test_rol_cl_reg() {
    ...
    assert_eq!(regs.rcx & 0xFF, 0xCC, "CL: 0x33 ROL 2 = 0xCC");
}
...
fn test_rol_dl() {
    ...
    assert_eq!(regs.rdx & 0xFF, 0xF0, "DL: 0x0F ROL 4 = 0xF0");
}
...
fn test_rol_ax_1() {
    ...
    let mut regs = Registers::default();
    regs.rax = 0x4321; // 0100_0011_0010_0001
    let (mut vcpu, _) = setup_vm(&code, Some(regs));
    let regs = run_until_hlt(&mut vcpu).unwrap();
...
fn test_rol_ax_cl() {
    ...
    assert_eq!(regs.rax & 0xFFFF, 0x2341, "AX: 0x1234 ROL 4 = 0x2341");
}
...
fn test_rol_ax_imm8() {
    ...
    assert_eq!(regs.rax & 0xFFFF, 0x3412, "AX: 0x1234 ROL 8 = 0x3412 (byte swap)");
}
...
fn test_rol_bx() {
    ...
    assert_eq!(regs.rbx & 0xFFFF, 0x0001, "BX: 0x8000 ROL 1 = 0x0001");
    assert!(cf_set(regs.rflags), "CF: MSB was 1");
}
...
fn test_rol_cx() {
    ...
    assert_eq!(regs.rcx & 0xFFFF, 0xBCDA, "CX: 0xABCD ROL 4 = 0xBCDA");
}
...
fn test_rol_dx_cl() {
    ...
    assert_eq!(regs.rdx & 0xFFFF, 0xFF00, "DX: 0x00FF ROL 8 = 0xFF00");
}
...
fn test_rol_eax_1() {
    ...
    assert_eq!(regs.rax & 0xFFFFFFFF, 0x86430ECA, "EAX: 0x43218765 ROL 1 = 0x86430ECA");
}
...
fn test_rol_eax_imm8() {
    ...
    assert_eq!(regs.rax & 0xFFFFFFFF, 0x56781234, "EAX: 0x12345678 ROL 16 = 0x56781234");
}
...
fn test_rol_ebx() {
    ...
    assert_eq!(regs.rbx & 0xFFFFFFFF, 0x00000001, "EBX: 0x80000000 ROL 1 = 0x00000001");
    assert!(cf_set(regs.rflags), "CF: MSB was 1");
}
...
fn test_rol_ecx() {
    ...
    assert_eq!(regs.rcx & 0xFFFFFFFF, 0xBCDEF01A, "ECX: 0xABCDEF01 ROL 4 = 0xBCDEF01A");
}
...
fn test_rol_edx_cl() {
    ...
    assert_eq!(regs.rdx & 0xFFFFFFFF, 0xFF000000, "EDX: 0x000000FF ROL 24 = 0xFF000000");
}
...
fn test_rol_esi() {
    ...
    assert_eq!(regs.rsi & 0xFFFFFFFF, 0x80000000, "ESI: 0x40000000 ROL 1 = 0x80000000");
}
...
fn test_rol_edi() {
    ...
    assert_eq!(regs.rdi & 0xFFFFFFFF, 0x45678123, "EDI: 0x12345678 ROL 12 = 0x45678123");
}
...
fn test_rol_rax_1() {
    ...
    assert_eq!(regs.rax, 0x86430ECA86430ECA, "RAX: ROL 1");
}
...
fn test_rol_rax_cl() {
    ...
    assert_eq!(regs.rax, 0x3456789ABCDEF012, "RAX: 0x123456789ABCDEF0 ROL 8");
}
...
fn test_rol_rax_32bits() {
    ...
    assert_eq!(regs.rax, 0x9ABCDEF012345678, "RAX: ROL 32 swaps high/low dwords");
}
...
fn test_rol_rbx() {
    ...
    assert_eq!(regs.rbx, 0x0000000000000001, "RBX: 0x8000000000000000 ROL 1 = 0x0000000000000001");
    assert!(cf_set(regs.rflags), "CF: MSB was 1");
}
...
fn test_rol_rcx() {
    ...
    assert_eq!(regs.rcx, 0xBCDEF0123456789A, "RCX: ROL 4");
}
...
fn test_rol_rdx_cl() {
    ...
    assert_eq!(regs.rdx, 0xFF00000000000000, "RDX: ROL 56");
}
...
fn test_rol_rsi() {
    ...
    assert_eq!(regs.rsi, 0x8000000000000000, "RSI: ROL 1");
}
...
fn test_rol_rdi() {
    ...
    assert_eq!(regs.rdi, 0x456789ABCDEF0123, "RDI: ROL 12");
}
...
fn test_rol_r8() {
    ...
    assert_eq!(regs.r8, 0xFDB97530ECA86421, "R8: ROL 1");
    assert!(cf_set(regs.rflags), "CF: MSB was 1");
}
...
fn test_rol_r9_cl() {
    ...
    assert_eq!(regs.r9, 0x456789ABCDEF0123, "R9: ROL 16");
}
...
fn test_rol_r10_imm8() {
    ...
    assert_eq!(regs.r10, 0x3456789ABCDEF012, "R10: ROL 8");
}
...
fn test_rol_r15() {
    ...
    assert_eq!(regs.r15, 0x2222222222222222, "R15: ROL 1");
}
...
fn test_rol_mem8() {
    ...
    assert_eq!(read_mem_u8(&mem), 0x03, "Memory: 0x81 ROL 1 = 0x03");
    assert!(cf_set(regs.rflags), "CF: MSB was 1");
}
...
fn test_rol_mem16() {
    ...
    assert_eq!(read_mem_u16(&mem), 0x2341, "Memory: 0x1234 ROL 4 = 0x2341");
}
...
fn test_rol_mem32() {
    ...
    assert_eq!(read_mem_u32(&mem), 0x34567812, "Memory: 0x12345678 ROL 8 = 0x34567812");
}
...
fn test_rol_mem64() {
    ...
    assert_eq!(read_mem_u64(&mem), 0x56789ABCDEF01234, "Memory: ROL 16");
}
