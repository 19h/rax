...
fn test_fnstenv_basic() {
    ...
    let code = [
        0xD9, 0x36, 0x25, 0x00, 0x30, 0x00, 0x00,  // FNSTENV [0x3000]
        0xF4,                                        // HLT
    ];
...
fn test_fnstenv_multiple_times() {
    ...
    let code = [
        0xDD, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00,  // FLD qword [0x2000]
        0xD9, 0x36, 0x25, 0x00, 0x30, 0x00, 0x00,  // FNSTENV [0x3000]
        0xD9, 0x36, 0x25, 0x00, 0x32, 0x00, 0x00,  // FNSTENV [0x3200]
        0xDD, 0x1C, 0x25, 0x08, 0x30, 0x00, 0x00,  // FSTP qword [0x3008]
        0xF4,                                        // HLT
    ];
...
fn test_fstenv_basic() {
    ...
    let code = [
        0x9B, 0xD9, 0x36, 0x25, 0x00, 0x30, 0x00, 0x00,  // FSTENV [0x3000]
        0xF4,                                              // HLT
    ];
...
fn test_fldenv_basic() {
    ...
    let code = [
        0xD9, 0x26, 0x25, 0x00, 0x20, 0x00, 0x00,  // FLDENV [0x2000]
...
fn test_fnstenv_fldenv_roundtrip() {
    ...
    let code = [
        0xDD, 0x2C, 0x25, 0x00, 0x20, 0x00, 0x00,  // FLDCW [0x2000] (set CW)
        0xD9, 0x36, 0x25, 0x00, 0x30, 0x00, 0x00,  // FNSTENV [0x3000] (save)
        0xDD, 0x2C, 0x25, 0x02, 0x20, 0x00, 0x00,  // FLDCW [0x2002] (change CW)
        0xD9, 0x26, 0x25, 0x00, 0x30, 0x00, 0x00,  // FLDENV [0x3000] (restore)
...
fn test_fnstenv_fldenv_preserves_all_fields() {
    ...
    let code = [
        ...
        0xD9, 0x36, 0x25, 0x00, 0x30, 0x00, 0x00,  // FNSTENV [0x3000]
        0xDB, 0xE3,                                  // FNINIT
        0xD9, 0x26, 0x25, 0x00, 0x30, 0x00, 0x00,  // FLDENV [0x3000]
        0xD9, 0x3C, 0x25, 0x00, 0x40, 0x00, 0x00,  // FNSTCW [0x4000]
        0xDF, 0xE0,                                  // FNSTSW AX
...
fn test_sequential_fldenv() {
    ...
    let code = [
        0xD9, 0x26, 0x25, 0x00, 0x20, 0x00, 0x00,  // FLDENV [0x2000]
        0xD9, 0x26, 0x25, 0x00, 0x22, 0x00, 0x00,  // FLDENV [0x2022]
        0xD9, 0x3C, 0x25, 0x00, 0x30, 0x00, 0x00,  // FNSTCW [0x3000]
        0xF4,                                        // HLT
    ];
...
fn test_fnstenv_fldenv_multiple_cycles() {
    ...
    let code = [
        ...
        0xD9, 0x36, 0x25, 0x00, 0x32, 0x00, 0x00,  // FNSTENV [0x3200]
        0xDB, 0xE3,                                  // FNINIT
        0xD9, 0x26, 0x25, 0x00, 0x32, 0x00, 0x00,  // FLDENV [0x3200]
