...
#[path = "../common/mod.rs"]
mod common;
use common::{run_until_hlt, setup_vm, write_mem_at_u16, write_mem_at_u64, read_mem_at_u16, read_mem_at_u64, DATA_ADDR};
...
fn test_sgdt_basic() {
    ...
    assert_eq!(regs.rip, 0x1000 + 9, "RIP should advance correctly");
