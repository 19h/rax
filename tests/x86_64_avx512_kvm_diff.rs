...
fn irregular_cases() -> Vec<Case> {
    ...
    for &(label, asm, feat, profile) in &[
        ...
        (
            "vpcompressd_avx512_sparse_mem_high_lane",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $15, %k1, %k1\nvpcompressd %zmm2, 64(%rax) {%k1}",
            F,
            Int,
        ),
        (
            "vpcompressq_avx512_sparse_mem_high_lane",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $7, %k1, %k1\nvpcompressq %zmm2, 64(%rax) {%k1}",
            F,
            Int,
        ),
        (
            "vcompressps_avx512_sparse_mem_high_lane",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $15, %k1, %k1\nvcompressps %zmm2, 64(%rax) {%k1}",
            F,
            F32,
        ),
        (
            "vcompresspd_avx512_sparse_mem_high_lane",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $7, %k1, %k1\nvcompresspd %zmm2, 64(%rax) {%k1}",
            F,
            F64,
        ),
        (
            "vpexpandd_avx512_sparse_mem_high_lane_zero",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $15, %k1, %k1\nvpexpandd 64(%rax), %zmm1 {%k1}{z}",
            F,
            Int,
        ),
        (
            "vpexpandq_avx512_sparse_mem_high_lane_zero",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $7, %k1, %k1\nvpexpandq 64(%rax), %zmm1 {%k1}{z}",
            F,
            Int,
        ),
        (
            "vexpandps_avx512_sparse_mem_high_lane_merge",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $15, %k1, %k1\nvexpandps 64(%rax), %zmm1 {%k1}",
            F,
            F32,
        ),
        (
            "vexpandpd_avx512_sparse_mem_high_lane_merge",
            "kxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $7, %k1, %k1\nvexpandpd 64(%rax), %zmm1 {%k1}",
            F,
            F64,
        ),
        (
            "vgatherdps_avx512_sparse_mem_high_lane",
            "vpxord %zmm2, %zmm2, %zmm2\nkxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $15, %k1, %k1\nvgatherdps 64(%rax,%zmm2,4), %zmm1 {%k1}",
            F,
            F32,
        ),
        (
            "vpgatherqq_avx512_sparse_mem_high_lane",
            "vpxord %zmm2, %zmm2, %zmm2\nkxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $7, %k1, %k1\nvpgatherqq 64(%rax,%zmm2,8), %zmm1 {%k1}",
            F,
            Int,
        ),
        (
            "vscatterdps_avx512_sparse_mem_high_lane",
            "vpxord %zmm2, %zmm2, %zmm2\nkxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $15, %k1, %k1\nvscatterdps %zmm3, 64(%rax,%zmm2,4) {%k1}",
            F,
            F32,
        ),
        (
            "vpscatterqq_avx512_sparse_mem_high_lane",
            "vpxord %zmm2, %zmm2, %zmm2\nkxnorw %k1, %k1, %k1\nkshiftrw $15, %k1, %k1\nkshiftlw $7, %k1, %k1\nvpscatterqq %zmm3, 64(%rax,%zmm2,8) {%k1}",
            F,
            Int,
        ),
...
fn undefined_opcode_cases() -> Vec<(&'static str, &'static [u8])> {
    vec![
        ...
        ("group11_c6_group1_reg_undefined", &[0xc6, 0xc8, 0x12]),
        ("group11_c6_group6_reg_undefined", &[0xc6, 0xf0, 0x12]),
        ("group11_c6_group1_mem_undefined", &[0xc6, 0x08, 0x12]),
        (
            "group11_c6_group7_non_xabort_undefined",
            &[0xc6, 0xf9, 0x12],
        ),
        (
            "group11_c7_group1_reg_undefined",
            &[0xc7, 0xc8, 0x78, 0x56, 0x34, 0x12],
        ),
        (
            "group11_c7_group6_reg_undefined",
            &[0xc7, 0xf0, 0x78, 0x56, 0x34, 0x12],
        ),
        (
            "group11_c7_group1_mem_undefined",
            &[0xc7, 0x08, 0x78, 0x56, 0x34, 0x12],
        ),
        (
            "group11_c7_group7_non_xbegin_undefined",
            &[0xc7, 0xf9, 0x00, 0x00, 0x00, 0x00],
        ),
        (
            "group11_c7_rexw_group1_reg_undefined",
            &[0x48, 0xc7, 0xc8, 0x78, 0x56, 0x34, 0x12],
        ),
...
const KEY_LOCKER_UNSUPPORTED_CANDIDATES: &[(&str, &[u8])] = &[
    ...
    (
        "loadiwkey_xmm3_xmm4_unsupported",
        &[0xf3, 0x0f, 0x38, 0xdc, 0xdc],
    ),
    (
        "loadiwkey_xmm8_xmm9_unsupported",
        &[0xf3, 0x45, 0x0f, 0x38, 0xdc, 0xc1],
    ),
    ("encodekey128_unsupported", &[0xf3, 0x0f, 0x38, 0xfa, 0x0b]),
    (
        "encodekey128_xmm2_rcx_unsupported",
        &[0xf3, 0x0f, 0x38, 0xfa, 0x11],
    ),
    (
        "encodekey128_xmm0_rbx_disp32_unsupported",
        &[0xf3, 0x0f, 0x38, 0xfa, 0x83, 0x00, 0x01, 0x00, 0x00],
    ),
    ("encodekey256_unsupported", &[0xf3, 0x0f, 0x38, 0xfb, 0x0b]),
    (
        "encodekey256_xmm3_rcx_unsupported",
        &[0xf3, 0x0f, 0x38, 0xfb, 0x19],
    ),
    (
        "encodekey256_xmm13_r8_unsupported",
        &[0xf3, 0x47, 0x0f, 0x38, 0xfb, 0x28],
    ),
    ("aesenc128kl_unsupported", &[0xf3, 0x0f, 0x38, 0xdc, 0x03]),
    (
        "aesenc128kl_xmm5_rdx_unsupported",
        &[0xf3, 0x0f, 0x38, 0xdc, 0x2a],
    ),
    ("aesdec128kl_unsupported", &[0xf3, 0x0f, 0x38, 0xdd, 0x03]),
    (
        "aesdec128kl_xmm14_r9_unsupported",
        &[0xf3, 0x47, 0x0f, 0x38, 0xdd, 0x31],
    ),
    ("aesenc256kl_unsupported", &[0xf3, 0x0f, 0x38, 0xde, 0x03]),
    (
        "aesenc256kl_xmm2_rcx_unsupported",
        &[0xf3, 0x0f, 0x38, 0xde, 0x11],
    ),
    ("aesdec256kl_unsupported", &[0xf3, 0x0f, 0x38, 0xdf, 0x03]),
    (
        "aesdec256kl_xmm3_rdx_unsupported",
        &[0xf3, 0x0f, 0x38, 0xdf, 0x1a],
    ),
    (
    ...
    (
        "aesencwide128kl_rcx_unsupported",
        &[0xf3, 0x0f, 0x38, 0xd8, 0x01],
    ),
    (
...
const AMX_DISABLED_CANDIDATES: &[(&str, &[u8])] = &[
    ...
    (
        "ldtilecfg_disp8_disabled",
        &[0xc4, 0xe2, 0x78, 0x49, 0x40, 0x40],
    ),
    ("ldtilecfg_r8_disabled", &[0xc4, 0xc2, 0x78, 0x49, 0x00]),
    ("sttilecfg_disabled", &[0xc4, 0xe2, 0x79, 0x49, 0x03]),
    (
        "sttilecfg_disp8_disabled",
        &[0xc4, 0xe2, 0x79, 0x49, 0x40, 0x60],
    ),
    ("sttilecfg_r9_disabled", &[0xc4, 0xc2, 0x79, 0x49, 0x01]),
    (
        "tileloadd_tmm0_disabled",
        &[0xc4, 0xe2, 0x7b, 0x4b, 0x04, 0x20],
    ),
    (
        "tileloadd_tmm2_disp8_disabled",
        &[0xc4, 0xe2, 0x7b, 0x4b, 0x54, 0x20, 0x40],
    ),
    (
        "tileloadd_tmm7_r8_disabled",
        &[0xc4, 0xc2, 0x7b, 0x4b, 0x3c, 0x20],
    ),
    (
        "tileloadd_tmm3_scaled_index_disabled",
        &[0xc4, 0xe2, 0x7b, 0x4b, 0x5c, 0x90, 0x20],
    ),
    (
        "tileloaddt1_tmm1_disabled",
        &[0xc4, 0xe2, 0x79, 0x4b, 0x0c, 0x21],
    ),
    (
        "tileloaddt1_tmm4_disp8_disabled",
        &[0xc4, 0xe2, 0x79, 0x4b, 0x64, 0x20, 0x60],
    ),
    (
        "tileloaddt1_tmm6_r9_disabled",
        &[0xc4, 0xc2, 0x79, 0x4b, 0x34, 0x21],
    ),
    (
        "tilestored_tmm0_disabled",
        &[0xc4, 0xe2, 0x7a, 0x4b, 0x04, 0x20],
    ),
    (
        "tilestored_tmm5_disp32_disabled",
        &[0xc4, 0xe2, 0x7a, 0x4b, 0xac, 0x20, 0x80, 0x00, 0x00, 0x00],
    ),
    (
        "tilestored_tmm7_r10_disabled",
        &[0xc4, 0xc2, 0x7a, 0x4b, 0x3c, 0x22],
    ),
    ("tilezero_tmm0_disabled", &[0xc4, 0xe2, 0x7b, 0x49, 0xc0]),
    ("tilezero_tmm7_disabled", &[0xc4, 0xe2, 0x7b, 0x49, 0xf8]),
    ("tilerelease_disabled", &[0xc4, 0xe2, 0x78, 0x49, 0xc0]),
    ("tdpbf16ps_tmm3_disabled", &[0xc4, 0xe2, 0x72, 0x5c, 0xda]),
    ("tdpbf16ps_tmm5_disabled", &[0xc4, 0xe2, 0x42, 0x5c, 0xee]),
    ("tdpbssd_tmm3_disabled", &[0xc4, 0xe2, 0x73, 0x5e, 0xda]),
    ("tdpbssd_tmm5_disabled", &[0xc4, 0xe2, 0x43, 0x5e, 0xee]),
    ("tdpbsud_tmm3_disabled", &[0xc4, 0xe2, 0x72, 0x5e, 0xda]),
    ("tdpbsud_tmm5_disabled", &[0xc4, 0xe2, 0x42, 0x5e, 0xee]),
    ("tdpbusd_tmm3_disabled", &[0xc4, 0xe2, 0x71, 0x5e, 0xda]),
...
fn invalid_extension_encoding_cases() -> Vec<(&'static str, &'static [u8])> {
    vec![
        ...
        (
            "evex_p0_fixed_bit_illegal",
            &[0x62, 0xf9, 0x7c, 0x48, 0x28, 0xc0],
        ),
        (
        ...
        (
            "cvtpd2dq_missing_mandatory_prefix_illegal",
            &[0x0f, 0xe6, 0xc1],
        ),
        (
        ...
        (
            "bmi1_bls_group0_selector_illegal",
            &[0xc4, 0xe2, 0xb8, 0xf3, 0xc1],
        ),
        (
            "bmi1_bls_group4_selector_illegal",
            &[0xc4, 0xe2, 0xb8, 0xf3, 0xe1],
        ),
        (
            "bmi1_bls_group5_selector_illegal",
            &[0xc4, 0xe2, 0xb8, 0xf3, 0xe9],
        ),
        (
            "bmi1_bls_group6_selector_illegal",
            &[0xc4, 0xe2, 0xb8, 0xf3, 0xf1],
        ),
        (
            "bmi1_bls_group7_selector_illegal",
            &[0xc4, 0xe2, 0xb8, 0xf3, 0xf9],
        ),
