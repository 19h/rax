...
/// firstcond=1 (value 1)
#[test]
fn test_aarch32_it_t1_a_combo_1_0_bf100000() {
    // Thumb encoding (32): 0xBF100000
    // Test aarch32_IT_T1_A field combination: firstcond=1, mask=0
    // ISET: T32
...
/// Requirement: FieldExtraction { field: "combination", bit_start: 0, bit_width: 32 }
/// firstcond=7 (midpoint (7))
#[test]
fn test_aarch32_it_t1_a_combo_2_0_bf700000() {
    // Thumb encoding (32): 0xBF700000
    // Test aarch32_IT_T1_A field combination: firstcond=7, mask=0
    // ISET: T32
    // Fields: firstcond=7, mask=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBF700000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
/// Requirement: FieldExtraction { field: "combination", bit_start: 0, bit_width: 32 }
/// firstcond=15 (maximum value (15))
#[test]
fn test_aarch32_it_t1_a_combo_3_0_bff00000() {
    // Thumb encoding (32): 0xBFF00000
    // Test aarch32_IT_T1_A field combination: firstcond=15, mask=0
    // ISET: T32
    // Fields: firstcond=15, mask=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBFF00000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_it_t1_a_combo_4_0_bf000000() {
    // Thumb encoding (32): 0xBF000000
    // Test aarch32_IT_T1_A field combination: firstcond=0, mask=0
    // ISET: T32
...
/// mask=1 (value 1)
#[test]
fn test_aarch32_it_t1_a_combo_5_0_bf010000() {
    // Thumb encoding (32): 0xBF010000
    // Test aarch32_IT_T1_A field combination: firstcond=0, mask=1
    // ISET: T32
    // Fields: mask=1, firstcond=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBF010000;
...
/// mask=7 (midpoint (7))
#[test]
fn test_aarch32_it_t1_a_combo_6_0_bf070000() {
    // Thumb encoding (32): 0xBF070000
    // Test aarch32_IT_T1_A field combination: firstcond=0, mask=7
    // ISET: T32
...
#[test]
fn test_aarch32_it_t1_a_combo_7_0_bf0f0000() {
    // Thumb encoding (32): 0xBF0F0000
    // Test aarch32_IT_T1_A field combination: firstcond=0, mask=15
    // ISET: T32
    // Fields: mask=15, firstcond=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBF0F0000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
