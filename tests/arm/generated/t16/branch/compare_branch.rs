...
#[test]
fn test_aarch32_cbnz_t1_a_combo_1_0_b9000000() {
    // Thumb encoding (32): 0xB9000000
    // Test aarch32_CBNZ_T1_A field combination: op=1, i=0, imm5=0, Rn=0
    // ISET: T32
    // Fields: op=1, Rn=0, i=0, imm5=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB9000000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
/// i=0 (minimum value)
#[test]
fn test_aarch32_cbnz_t1_a_combo_2_0_b1000000() {
    // Thumb encoding (32): 0xB1000000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=0, Rn=0
    // ISET: T32
    // Fields: i=0, imm5=0, op=0, Rn=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1000000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
/// i=1 (maximum value (1))
#[test]
fn test_aarch32_cbnz_t1_a_combo_3_0_b3000000() {
    // Thumb encoding (32): 0xB3000000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=1, imm5=0, Rn=0
    // ISET: T32
    // Fields: Rn=0, op=0, i=1, imm5=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB3000000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_4_0_b1000000() {
    // Thumb encoding (32): 0xB1000000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=0, Rn=0
    // ISET: T32
    // Fields: op=0, imm5=0, Rn=0, i=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1000000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_5_0_b1080000() {
    // Thumb encoding (32): 0xB1080000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=1, Rn=0
    // ISET: T32
    // Fields: op=0, imm5=1, i=0, Rn=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1080000;
...
/// imm5=3 (2^2 - 1 = 3)
#[test]
fn test_aarch32_cbnz_t1_a_combo_6_0_b1180000() {
    // Thumb encoding (32): 0xB1180000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=3, Rn=0
    // ISET: T32
    // Fields: i=0, op=0, Rn=0, imm5=3
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1180000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_7_0_b1200000() {
    // Thumb encoding (32): 0xB1200000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=4, Rn=0
    // ISET: T32
    // Fields: Rn=0, i=0, op=0, imm5=4
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1200000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
/// imm5=7 (2^3 - 1 = 7)
#[test]
fn test_aarch32_cbnz_t1_a_combo_8_0_b1380000() {
    // Thumb encoding (32): 0xB1380000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=7, Rn=0
    // ISET: T32
    // Fields: op=0, imm5=7, Rn=0, i=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1380000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_9_0_b1400000() {
    // Thumb encoding (32): 0xB1400000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=8, Rn=0
    // ISET: T32
    // Fields: op=0, i=0, Rn=0, imm5=8
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1400000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_10_0_b1780000() {
    // Thumb encoding (32): 0xB1780000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=15, Rn=0
    // ISET: T32
    // Fields: op=0, imm5=15, i=0, Rn=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1780000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_11_0_b1800000() {
    // Thumb encoding (32): 0xB1800000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=16, Rn=0
    // ISET: T32
    // Fields: Rn=0, i=0, imm5=16, op=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1800000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_12_0_b1f80000() {
    // Thumb encoding (32): 0xB1F80000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=31, Rn=0
    // ISET: T32
    // Fields: op=0, imm5=31, i=0, Rn=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1F80000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_13_0_b1000000() {
    // Thumb encoding (32): 0xB1000000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=0, Rn=0
    // ISET: T32
    // Fields: Rn=0, i=0, imm5=0, op=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1000000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
#[test]
fn test_aarch32_cbnz_t1_a_combo_14_0_b1010000() {
    // Thumb encoding (32): 0xB1010000
    // Test aarch32_CBNZ_T1_A field combination: op=0, i=0, imm5=0, Rn=1
    // ISET: T32
    // Fields: op=0, i=0, imm5=0, Rn=1
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xB1010000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
