...
/// opt=1 (option 1)
#[test]
fn test_aarch32_dcps_t1_a_combo_1_8000_f78f8001() {
    // Thumb encoding (32): 0xF78F8001
    // Test aarch32_DCPS_T1_A field combination: opt=1
    // ISET: T32
    // Fields: opt=1
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xF78F8001;
...
/// opt=2 (option 2)
#[test]
fn test_aarch32_dcps_t1_a_combo_2_8000_f78f8002() {
    // Thumb encoding (32): 0xF78F8002
    // Test aarch32_DCPS_T1_A field combination: opt=2
    // ISET: T32
    // Fields: opt=2
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xF78F8002;
...
/// opt=3 (option 3)
#[test]
fn test_aarch32_dcps_t1_a_combo_3_8000_f78f8003() {
    // Thumb encoding (32): 0xF78F8003
    // Test aarch32_DCPS_T1_A field combination: opt=3
    // ISET: T32
    // Fields: opt=3
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xF78F8003;
