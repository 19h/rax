...
const MANIFESTS: &[(&str, &str)] = &[
    (
        ...
        include_str!("../../../generated/x86_64/inventories/avx.txt"),
    ),
    (
        "avx2_unimplemented_mnemonics.txt",
        include_str!("../../../generated/x86_64/inventories/avx2.txt"),
    ),
    (
        "avx10_unimplemented_mnemonics.txt",
        include_str!("../../../generated/x86_64/inventories/avx10.txt"),
    ),
    (
        "avx512_unimplemented_mnemonics.txt",
        include_str!("../../../generated/x86_64/inventories/avx512.txt"),
    ),
    (
        "apx_unimplemented_mnemonics.txt",
        include_str!("../../../generated/x86_64/inventories/apx.txt"),
    ),
];
...
fn local_simd_test_mnemonics(
    ...
    let root = Path::new(env!("CARGO_MANIFEST_DIR")).join("tests/suites/isa/x86_64/simd");
