use crate::common::{
    Bytes, GuestAddress, GuestMemoryMmap, IDT_BASE, INT_HANDLER_ADDR, run_until_hlt, setup_vm,
    setup_vm_compat, write_mem_at_u16, write_mem_at_u32,
};
...
fn test_bound_16bit_within_bounds() {
    ...
    let code = [
        ...
        0x67, 0x62, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, // BOUND AX, [0x2000]
...
fn test_bound_sib_addressing() {
    ...
    let code = [
        ...
        0x67, 0x62, 0x04, 0x8b, // BOUND AX, [RBX + RCX*4]
...
fn test_bound_with_different_registers() {
    ...
    let code = [
        ...
        0x67, 0x62, 0x1c, 0x25, 0x00, 0x20, 0x00, 0x00, // BOUND BX, [0x2000]
...
fn test_bound_cx_register() {
    let code = [
        ...
        0x67, 0x62, 0x0c, 0x25, 0x00, 0x20, 0x00, 0x00, // BOUND CX, [0x2000]
...
fn test_bound_dx_register() {
    let code = [
        ...
        0x67, 0x62, 0x14, 0x25, 0x00, 0x20, 0x00, 0x00, // BOUND DX, [0x2000]
