...
fn test_vfmadd132sd_xmm0_xmm1_mem() {
    let code = [
        0xc4, 0xe2, 0xf1, 0x99, 0x04, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD132SD XMM0, XMM1, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd213sd_xmm0_xmm1_mem() {
    let code = [
        0xc4, 0xe2, 0xf1, 0xa9, 0x04, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD213SD XMM0, XMM1, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd231sd_xmm0_xmm1_mem() {
    let code = [
        0xc4, 0xe2, 0xf1, 0xb9, 0x04, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD231SD XMM0, XMM1, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd132sd_xmm15_xmm8_mem() {
    let code = [
        0xc4, 0x62, 0xb9, 0x99, 0x3c, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD132SD XMM15, XMM8, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd213sd_xmm15_xmm8_mem() {
    let code = [
        0xc4, 0x62, 0xb9, 0xa9, 0x3c, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD213SD XMM15, XMM8, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd231sd_xmm15_xmm8_mem() {
    let code = [
        0xc4, 0x62, 0xb9, 0xb9, 0x3c, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD231SD XMM15, XMM8, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
