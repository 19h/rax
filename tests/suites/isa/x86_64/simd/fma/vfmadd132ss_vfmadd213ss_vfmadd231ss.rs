...
fn test_vfmadd132ss_xmm0_xmm1_mem() {
    ...
    let code = [
        0xc4, 0xe2, 0x71, 0x99, 0x04, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD132SS XMM0, XMM1, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd213ss_xmm0_xmm1_mem() {
    ...
    let code = [
        0xc4, 0xe2, 0x71, 0xa9, 0x04, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD213SS XMM0, XMM1, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd231ss_xmm0_xmm1_mem() {
    ...
    let code = [
        0xc4, 0xe2, 0x71, 0xb9, 0x04, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD231SS XMM0, XMM1, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd132ss_xmm15_xmm8_mem() {
    ...
    let code = [
        0xc4, 0x62, 0x39, 0x99, 0x3c, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD132SS XMM15, XMM8, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd213ss_xmm15_xmm8_mem() {
    ...
    let code = [
        0xc4, 0x62, 0x39, 0xa9, 0x3c, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD213SS XMM15, XMM8, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vfmadd231ss_xmm15_xmm8_mem() {
    ...
    let code = [
        0xc4, 0x62, 0x39, 0xb9, 0x3c, 0x25, 0x00, 0x30, 0x00,
        0x00, // VFMADD231SS XMM15, XMM8, [0x3000]
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
