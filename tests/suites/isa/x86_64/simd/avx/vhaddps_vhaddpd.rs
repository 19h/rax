...
fn test_vhaddps_xmm_mem_extended() {
    ...
    let code = [
        0xc4, 0xc1, 0x23, 0x7c, 0x15, 0x00, 0x40, 0x00,
        0x00, // VHADDPS XMM10, XMM11, [rip+0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vhaddps_ymm_mem_extended() {
    ...
    let code = [
        0xc4, 0xc1, 0x27, 0x7c, 0x15, 0x00, 0x40, 0x00,
        0x00, // VHADDPS YMM10, YMM11, [rip+0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vhaddpd_xmm_mem_extended() {
    ...
    let code = [
        0xc4, 0xc1, 0x23, 0x7c, 0x15, 0x00, 0x40, 0x00,
        0x00, // VHADDPD XMM10, XMM11, [rip+0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vhaddpd_ymm_mem_extended() {
    ...
    let code = [
        0xc4, 0xc1, 0x27, 0x7c, 0x15, 0x00, 0x40, 0x00,
        0x00, // VHADDPD YMM10, YMM11, [rip+0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
