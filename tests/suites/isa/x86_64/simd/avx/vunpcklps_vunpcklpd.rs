...
fn test_vunpcklps_xmm0_xmm1_mem128() {
    ...
    let code = [
        0xc5, 0xf0, 0x14, 0x05, 0x00, 0x40, 0x00,
        0x00, // VUNPCKLPS XMM0, XMM1, [rip + 0x4000]
        0xf4, // HLT
    ];
...
fn test_vunpcklps_ymm0_ymm1_mem256() {
    ...
    let code = [
        0xc5, 0xf4, 0x14, 0x05, 0x00, 0x40, 0x00,
        0x00, // VUNPCKLPS YMM0, YMM1, [rip + 0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vunpcklps_xmm8_xmm9_mem128() {
    ...
    let code = [
        0xc4, 0xc1, 0x30, 0x14, 0x05, 0x00, 0x40, 0x00,
        0x00, // VUNPCKLPS XMM8, XMM9, [rip + 0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vunpcklpd_xmm0_xmm1_mem128() {
    ...
    let code = [
        0xc5, 0xf1, 0x14, 0x05, 0x00, 0x40, 0x00,
        0x00, // VUNPCKLPD XMM0, XMM1, [rip + 0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vunpcklpd_ymm0_ymm1_mem256() {
    ...
    let code = [
        0xc5, 0xf5, 0x14, 0x05, 0x00, 0x40, 0x00,
        0x00, // VUNPCKLPD YMM0, YMM1, [rip + 0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
...
fn test_vunpcklpd_xmm8_xmm9_mem128() {
    ...
    let code = [
        0xc4, 0xc1, 0x31, 0x14, 0x05, 0x00, 0x40, 0x00,
        0x00, // VUNPCKLPD XMM8, XMM9, [rip + 0x4000]
        0xf4, // HLT
    ];
    let (mut vcpu, mem) = setup_vm(&code, None);
