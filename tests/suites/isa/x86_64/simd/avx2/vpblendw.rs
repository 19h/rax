...
fn test_vpblendw_xmm0_xmm1_mem() {
    let code = [
        0xc4, 0xe3, 0x71, 0x0e, 0x05, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
...
fn test_vpblendw_xmm1_xmm2_mem() {
    let code = [
        0xc4, 0xe3, 0x69, 0x0e, 0x0d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_xmm2_xmm3_mem() {
    let code = [
        0xc4, 0xe3, 0x61, 0x0e, 0x15, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_xmm3_xmm4_mem() {
    let code = [
        0xc4, 0xe3, 0x59, 0x0e, 0x1d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_xmm4_xmm5_mem() {
    let code = [
        0xc4, 0xe3, 0x51, 0x0e, 0x25, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_xmm5_xmm6_mem() {
    let code = [
        0xc4, 0xe3, 0x49, 0x0e, 0x2d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_xmm6_xmm7_mem() {
    let code = [
        0xc4, 0xe3, 0x41, 0x0e, 0x35, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_xmm7_xmm8_mem() {
    let code = [
        0xc4, 0xe3, 0x39, 0x0e, 0x3d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 16];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_ymm0_ymm1_mem256() {
    let code = [
        0xc4, 0xe3, 0x75, 0x0e, 0x05, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
...
fn test_vpblendw_ymm1_ymm2_mem256() {
    let code = [
        0xc4, 0xe3, 0x6d, 0x0e, 0x0d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 32];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_ymm2_ymm3_mem256() {
    let code = [
        0xc4, 0xe3, 0x65, 0x0e, 0x15, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 32];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_ymm3_ymm4_mem256() {
    let code = [
        0xc4, 0xe3, 0x5d, 0x0e, 0x1d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 32];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_ymm4_ymm5_mem256() {
    let code = [
        0xc4, 0xe3, 0x55, 0x0e, 0x25, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 32];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
...
fn test_vpblendw_ymm5_ymm6_mem256() {
    let code = [
        0xc4, 0xe3, 0x4d, 0x0e, 0x2d, 0xf6, 0x1f, 0x00, 0x00, 0x00, 0xf4,
    ];
    let (mut vcpu, vm_memory) = setup_vm(&code, None);
    let test_data = [0u8; 32];
    vm_memory.write(&test_data, GuestAddress(0x3000)).unwrap();
