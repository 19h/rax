...
fn test_vptest_ymm11_mem() {
    ...
    let data = vec![
        0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
        0x55, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F,
        0x0F, 0x0F,
    ];
    mem.write_slice(&data, GuestAddress(ALIGNED_ADDR)).unwrap();
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vptest_xmm_chain() {
    // Chain multiple VPTEST operations
    let code = [
        0xc4, 0xe2, 0x79, 0x17, 0xc1, // VPTEST XMM0, XMM1
...
fn test_vptest_ymm_mem_alternating() {
    ...
    let data = vec![
        0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA,
        0x55, 0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F,
        0xF0, 0x0F,
    ];
    mem.write_slice(&data, GuestAddress(ALIGNED_ADDR)).unwrap();
    run_until_hlt(&mut vcpu).unwrap();
...
fn test_vptest_mixed_sizes() {
    // Mix 128-bit and 256-bit VPTEST operations
    let code = [
        0xc4, 0xe2, 0x79, 0x17, 0xc1, // VPTEST XMM0, XMM1
        0xc4, 0xe2, 0x7d, 0x17, 0xd2, // VPTEST YMM2, YMM2
        0xc4, 0xe2, 0x79, 0x17, 0xe3, // VPTEST XMM4, XMM3
