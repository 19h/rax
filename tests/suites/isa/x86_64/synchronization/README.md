...
```bash
cargo test --test x86_64 --features x86_64-suite x86_64_sync_cmpxchg::
```

To run specific test categories:
```bash
# All 8-bit tests
cargo test --test x86_64 --features x86_64-suite x86_64_sync_cmpxchg::test_cmpxchg_8bit

# All flag behavior tests
cargo test --test x86_64 --features x86_64-suite x86_64_sync_cmpxchg::test_cmpxchg_.*flag

# All practical pattern tests
cargo test --test x86_64 --features x86_64-suite x86_64_sync_cmpxchg::test_cmpxchg_.*pattern
```
