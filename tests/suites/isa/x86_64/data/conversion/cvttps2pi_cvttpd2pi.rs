...
fn test_cvttpd2pi_larger_values() {
    ...
    assert_eq!(
        get_mm(&regs, 0),
        pack_i32x2(123, -456),
        "CVTTPD2PI [123.99,-456.99] -> [123,-456]"
    );
}
