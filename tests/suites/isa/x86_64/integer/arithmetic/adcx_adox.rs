...
fn test_256bit_addition_pattern() {
    ...
    let code = [
        ...
        0x66, 0x48, 0x0f, 0x38, 0xf6, 0xc3, // ADCX RAX, RBX
        // Limb 1
        0x48, 0xb9, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, // MOV RCX, 0xFFFFFFFFFFFFFFFE
...
fn test_adcx_64bit_power_of_two() {
    let code = [
        ...
        0x48, 0xbb, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
        0x00, // MOV RBX, 0x0000000100000000
        0x66, 0x48, 0x0f, 0x38, 0xf6, 0xc3, // ADCX RAX, RBX
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
...
fn test_adox_64bit_power_of_two() {
    let code = [
        0x31, 0xc0, // XOR EAX, EAX
        0x48, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
        0x00, // MOV RAX, 0x0000000200000000
        0x48, 0xbb, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
        0x00, // MOV RBX, 0x0000000200000000
        0xf3, 0x48, 0x0f, 0x38, 0xf6, 0xc3, // ADOX RAX, RBX
        0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
...
fn test_adcx_64bit_full_range() {
    let code = [
        ...
        0x7f, // MOV RAX, 0x7FFFFFFFFFFFFFFE
        0x48, 0xbb, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // MOV RBX, 1
        0x66, 0x48, 0x0f, 0x38, 0xf6, 0xc3, // ADCX RAX, RBX
        0xf4, // HLT
    ];
