...
fn test_all_avx10_2_saturation_converts() {
    let test_cases = [
        ([0x62, 0xF5, 0x7C, 0x48, 0x68, 0xCA], "VCVTTPH2IBS"),
        ([0x62, 0xF5, 0x7C, 0x48, 0x6A, 0xCA], "VCVTTPH2IUBS"),
        ([0x62, 0xF5, 0x7C, 0x48, 0x69, 0xCA], "VCVTPH2IBS"),
        ([0x62, 0xF5, 0x7C, 0x48, 0x6B, 0xCA], "VCVTPH2IUBS"),
        ...
        ([0x62, 0xF5, 0xFC, 0x08, 0x6D, 0xCA], "VCVTTPD2DQS"),
        ([0x62, 0xF5, 0xFC, 0x28, 0x6C, 0xCA], "VCVTTPD2UDQS"),
        ([0x62, 0xF5, 0x7C, 0x48, 0x6D, 0xCA], "VCVTTPS2DQS"),
        ([0x62, 0xF5, 0x7C, 0x48, 0x6C, 0xCA], "VCVTTPS2UDQS"),
        ([0x62, 0xF5, 0x7D, 0x28, 0x6D, 0xCA], "VCVTTPS2QQS"),
        ([0x62, 0xF5, 0x7D, 0x48, 0x6C, 0xCA], "VCVTTPS2UQQS"),
        ([0x62, 0xF5, 0x7F, 0x48, 0x68, 0xCA], "VCVTTBF162IBS"),
        ([0x62, 0xF5, 0x7F, 0x48, 0x6A, 0xCA], "VCVTTBF162IUBS"),
        ([0x62, 0xF5, 0x7F, 0x48, 0x69, 0xCA], "VCVTBF162IBS"),
        ([0x62, 0xF5, 0x7F, 0x48, 0x6B, 0xCA], "VCVTBF162IUBS"),
        ([0x62, 0xF5, 0x7F, 0x08, 0x6D, 0xCA], "VCVTTSD2SIS r32"),
        (
            [0x62, 0xF5, 0xFF, 0x18, 0x6D, 0xCA],
            "VCVTTSD2SIS r64 {sae}",
        ),
        ([0x62, 0xF5, 0x7F, 0x08, 0x6C, 0xCA], "VCVTTSD2USIS r32"),
        (
            [0x62, 0xF5, 0xFF, 0x18, 0x6C, 0xCA],
            "VCVTTSD2USIS r64 {sae}",
        ),
        ([0x62, 0xF5, 0x7E, 0x08, 0x6D, 0xCA], "VCVTTSS2SIS r32"),
        (
            [0x62, 0xF5, 0xFE, 0x18, 0x6D, 0xCA],
            "VCVTTSS2SIS r64 {sae}",
        ),
        ([0x62, 0xF5, 0x7E, 0x08, 0x6C, 0xCA], "VCVTTSS2USIS r32"),
        (
            [0x62, 0xF5, 0xFE, 0x18, 0x6C, 0xCA],
            "VCVTTSS2USIS r64 {sae}",
        ),
    ];
