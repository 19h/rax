//! Native-prefix handoff coverage for unassigned 3DNow! suffix bytes.

use super::*;

#[test]
fn jit_commits_supported_prefix_before_unassigned_3dnow_suffix_ud() {
    for (name, invalid) in [
        ("register form", &[0x0F, 0x0F, 0xC1, 0x00][..]),
        (
            "SIB plus disp32 memory form",
