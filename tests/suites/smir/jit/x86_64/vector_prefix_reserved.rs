//! Native-prefix handoff coverage for reserved and profile-disabled vector maps.

use super::*;

#[test]
fn jit_commits_supported_prefix_before_invalid_vector_map_ud() {
    for (name, invalid) in [
        ("reserved VEX MAP4", &[0xC4, 0xE4, 0x78, 0x00][..]),
        (
            "profile-disabled VEX MAP5 AMX-FP8",
            &[0xC4, 0xE5, 0x78, 0xFD, 0xC0][..],
        ),
        ("reserved EVEX MAP0", &[0x62, 0xF0, 0x7C, 0x08, 0x00][..]),
        ("reserved EVEX MAP7", &[0x62, 0xF7, 0x7C, 0x08, 0x00][..]),
        (
            "reserved EVEX MAP0 with invalid P0[3]",
            &[0x62, 0xF8, 0x7C, 0x08][..],
        ),
    ] {
