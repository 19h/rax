...
def generate_parent_mod_rs_recursive(base_path: Path, path_parts: List[str]):
    ...
    if path_parts:  # Don't write for empty path (root)
        ...
        # This handles suites such as tests/suites/isa/arm declaring a32, a64, etc.
...
def main():
    ...
    tests_arm_path = repo_root / "tests/suites/isa/arm"
    structure_json_path = tests_arm_path / "structure.json"
    asl_path = repo_root / "docs/architecture/arm/asl/arm_instrs.asl"
    output_base = tests_arm_path
